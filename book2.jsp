...
<body>
    ...
    session.setAttribute("bc1",checkinDateStr);
    session.setAttribute("bc2",checkoutDateStr);
    ...
    try {
      ...
      c5=cost[4];
      c6=cost[5];
      PreparedStatement stm = con.prepareStatement("SELECT ROOMTYPE, SUM(BOOKEDROOMS) AS TOTAL_BOOKED_ROOMS FROM BOOKINGS WHERE ROOMTYPE IS NOT NULL AND ( (CHECKIN >= ? AND CHECKIN <= ?) OR (CHECKOUT >= ? AND CHECKOUT <= ?) OR (CHECKIN <= ? AND CHECKOUT >= ?)) GROUP BY ROOMTYPE");
  ...
  <div class="container">
      <div class="row">
          ...
          <div class="card text-center h-100">
            ...
            %>
              <form method="post" action="rooms.jsp">
                <input type="hidden" name="availableRooms" value="<%=a5%>">
              ...
              <br><p><span class="spinner-border spinner-grow text-danger " style="width: 20px; height:20px;"></span>&ensp;
                <button type="submit" class="btn btn-danger">Book Now</button></p>
              </form>
              <% 
              }
              else{
              ...
              <h5 class="card-title">Suite Room</h5>
                  <p class="card-text">Rate: Rs.<%=c5%> per day<br>Available Rooms: <% out.println(a5); %></p>   
              <br><br><br><button class="btn btn-danger">No Rooms Available</button>
              <%
              }
            %> 
        ...
        <div class="col-12 col-md-4 col-lg-4 mb-4">
          ...
          %>
              <form method="post" action="rooms.jsp">
                <input type="hidden" name="availableRooms" value="<%=a2%>">
                <input type="hidden" name="roomtype" value="dulex">
        ...
        <div class="col-12 col-md-4 col-lg-4 mb-4">
          ...
          %>
              <form method="post" action="rooms.jsp">
                <input type="hidden" name="availableRooms" value="<%=a1%>">
              ...
              <br><p><span class="spinner-border spinner-grow text-danger " style="width: 20px; height:20px;"></span>&ensp;
                ...
                <br><br><button class="btn btn-danger">No Rooms Available</button>
                <%
              }
            %> 
    ...
    <div class="row">
      <div class="col-12 col-md-4 col-lg-4 mb-4">
        <div class="card text-center h-100">
          ...
          <div class="card-body">
            ...
            if(a4>0){
          %>
            <form mathod="post" action="rooms.jsp">
              <input type="hidden" name="availableRooms" value="<%=a4%>">
            ...
            <h5 class="card-title">Luxury Room</h5>
                <p class="card-text">Rate: Rs.<%=c4%> per day<br>Available Rooms: <% out.println(a4); %></p>
              <br><button class="btn btn-danger">No Rooms Available</button>
              <%
              }
            %> 
      ...
      <div class="col-12 col-md-4 col-lg-4 mb-4">
        <div class="card text-center h-100">
          ...
          %>
            <form method="post" action="rooms.jsp">
              <input type="hidden" name="availableRooms" value="<%=a3%>">
                <input type="hidden" name="roomtype" value="triple">
            ...
            <h5 class="card-title">Triple Room</h5>
              ...
              <% 
                ...
                <p class="card-text">Rate: Rs.<%=c3%> per day<br>Available Rooms: <% out.println(a3); %></p>
              <br>
              <button class="btn btn-danger">No Rooms Available</button>
              <%
              }
            %> 
      ...
      <div class="col-12 col-md-4 col-lg-4 mb-4">
        <div class="card text-center h-100">
          ...
          %>
            <form method="post" action="rooms.jsp">
              <input type="hidden" name="availableRooms" value="<%=a5%>">
                <input type="hidden" name="roomtype" value="guest-house">
            ...
            <p class="card-text"><button><i class="fa fa-bed"></i> &ensp; Bed Options &ensp;</button> <button><i class="fa fa-male"></i><i class="fa fa-female"></i> &ensp; Pax</button></p>
            <h5 class="card-title">Guest House</h5>
                <p class="card-text">Rate: Rs.<%=c6%> per day<br>Available Rooms: <% out.println(a6); %></p><br>
                <button class="btn btn-danger">No Rooms Available</button>
              <%
              }
            %>            
