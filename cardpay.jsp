...
<html lang = "en">
   ...
   <body>
    ...
    %>
      <div class = "container">
         <h2>CONFIRMATION</h2>
         <form method="post" action="card_db.jsp">
            <div class="form-row">
            ...
            <div class="form-row">
             ...
             <div class="form-row">
               <div class = "form-group col">
                  ...
                  <input type="text" class="form-control" id="payment_type" name="payment_type" value="credit card" readonly required/>
               </div>
               </div>
             <div class="form-row">
               <div class = "form-group col">
               ...
               <div class="form-row">
                  <div class = "form-group col">
                     ...
                     <input type="text" class="form-control" id="holder_name" name="holder_name" placeholder="Enter Card holder name" required/>
                  </div>
                  <div class = "form-group col">
