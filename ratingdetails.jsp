...
<body>
    <nav class="navbar navbar-dark bg-dark fixed-top navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav container-fluid">
                ...
                <a class="nav-link active" href="#">RATING DETAILS</a>
    ...
    <br><br><br>
    <center><h3 style="color: blue;"><b>RATING DETAILS</b></h3></center>
	<table>
		<tr>
			<th>Email</th>
			<th>Rating</th>
		...
		<%
			try{
				...
				PreparedStatement check_stm=con.prepareStatement("select * from rating");
