...
<%
      ...
      try {
        ...
        PreparedStatement check_stm=con.prepareStatement("select * from user_signup where email=?");
...
<%
          ...
          PreparedStatement stm=con.prepareStatement("insert into user_signup(name,email,mobile,address,password) values (?, ?, ?, ?, ?)");
