...
<html lang = "en">
   ...
   <body>
    ...
    %>
      <div class = "container">
         <h2>CONFIRMATION</h2>
         <form method="post" action="upi_db.jsp">
            <div class="form-row">
            ...
            <div class="form-row">
             ...
             <div class="form-row">
               <div class = "form-group col">
                  <label for = "text">UPI ID</label>
                  <input type="text" class="form-control" id="upi-number" name="upi_id" placeholder="Enter UPI ID" required minlength="4" maxlength="20"/>
               </div>
                <div class = "form-group col">
                   <label for = "text">Payment Type</label>
                   <input type="text" class="form-control" id="payment_type" name="payment_type" value="UPI" readonly required/>
              </div>
              </div>
