...
<body>
    ...
    <br><br><br>
    <center><h3 style="color: blue;"><b>DETAILS OF USERS</b></h3></center>
	<table>
		<tr>
			<th>Name</th>
			<th>Email</th>
		...
		<%
			try{
				...
				PreparedStatement check_stm=con.prepareStatement("select * from user_signup");
    ...
    <div class="bot">
        <p class="end"><a href="project1.html">Samanvay Boutique Hotel</a>&ensp;|  Website Terms of Use | Accessibility Information<br>
